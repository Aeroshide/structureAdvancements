...
public class StructureAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(HolderLookup.Provider registries, Consumer<AdvancementHolder> exporter) {
        ...
        String rootIconId = IconBindings.getIcon(MCVersion.V1_21, "root");
        ...
        DisplayInfo rootDisplay = new DisplayInfo(
                ...
                Optional.of(ResourceLocation.fromNamespaceAndPath("minecraft", "block/amethyst_block")),
        ...
        String overworldIconId = IconBindings.getIcon(MCVersion.V1_21, "overworld");
        ...
        DisplayInfo overworldDisplay = new DisplayInfo(
                ...
                Component.literal(CommonStrings.getDimensionTitle(MCVersion.V1_21, "overworld")),
                Component.literal(CommonStrings.getDimensionDescription(MCVersion.V1_21, "overworld")),
                Optional.empty(),
        ...
        String netherIconId = IconBindings.getIcon(MCVersion.V1_21, "nether");
        ...
        DisplayInfo netherDisplay = new DisplayInfo(
                ...
                Component.literal(CommonStrings.getDimensionTitle(MCVersion.V1_21, "nether")),
                Component.literal(CommonStrings.getDimensionDescription(MCVersion.V1_21, "nether")),
                Optional.empty(),
        ...
        String endIconId = IconBindings.getIcon(MCVersion.V1_21, "end");
        ...
        DisplayInfo endDisplay = new DisplayInfo(
                ...
                Component.literal(CommonStrings.getDimensionTitle(MCVersion.V1_21, "end")),
                Component.literal(CommonStrings.getDimensionDescription(MCVersion.V1_21, "end")),
                Optional.empty(),
    ...
    private void addStructureAdvancement(
        ...
        String iconId = IconBindings.getIcon(MCVersion.V1_21, name);
