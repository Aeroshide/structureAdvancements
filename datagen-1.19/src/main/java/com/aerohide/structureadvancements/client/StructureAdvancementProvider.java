...
public class StructureAdvancementProvider extends FabricAdvancementProvider {
    ...
    public void generateAdvancement(Consumer<Advancement> consumer) {
        ...
        String rootIconId = IconBindings.getIcon(MCVersion.V1_19, "root");
        ...
        String overworldIconId = IconBindings.getIcon(MCVersion.V1_19, "overworld");
        ...
        DisplayInfo overworldDisplay = new DisplayInfo(
            ...
            Component.literal(CommonStrings.getDimensionTitle(MCVersion.V1_19, "overworld")),
            Component.literal(CommonStrings.getDimensionDescription(MCVersion.V1_19, "overworld")),
            null,
        ...
        String netherIconId = IconBindings.getIcon(MCVersion.V1_19, "nether");
        ...
        DisplayInfo netherDisplay = new DisplayInfo(
            ...
            Component.literal(CommonStrings.getDimensionTitle(MCVersion.V1_19, "nether")),
            Component.literal(CommonStrings.getDimensionDescription(MCVersion.V1_19, "nether")),
            null,
        ...
        String endIconId = IconBindings.getIcon(MCVersion.V1_19, "end");
        ...
        DisplayInfo endDisplay = new DisplayInfo(
            ...
            Component.literal(CommonStrings.getDimensionTitle(MCVersion.V1_19, "end")),
            Component.literal(CommonStrings.getDimensionDescription(MCVersion.V1_19, "end")),
            null,
    ...
    private void createStructureAdvancement(
        ...
        String iconId = IconBindings.getIcon(MCVersion.V1_19, name);
